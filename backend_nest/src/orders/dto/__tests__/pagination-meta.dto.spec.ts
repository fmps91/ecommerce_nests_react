...
describe('PaginationMetaDto - Orders', () => {
  ...
  describe('order-specific pagination scenarios', () => {
    it('should handle orders pagination with large total', () => {
      ...
      const dto = new PaginationMetaDto(ordersPagination);

      expect(dto.total).toBe(50000);
      expect(dto.page).toBe(250);
    ...
    it('should handle recent orders scenario', () => {
      const recentOrders = {
        total: 25,
        page: 1,
        limit: 10,
      ...
      const dto = new PaginationMetaDto(recentOrders);
    ...
    it('should handle user orders scenario', () => {
      const userOrders = {
        total: 8,
        page: 1,
        limit: 20,
      ...
      const dto = new PaginationMetaDto(userOrders);
    ...
    it('should handle completed orders scenario', () => {
      ...
      const dto = new PaginationMetaDto(completedOrders);
    ...
    it('should handle pending orders scenario', () => {
      const pendingOrders = {
        total: 12,
        page: 2,
        limit: 5,
      ...
      const dto = new PaginationMetaDto(pendingOrders);
  ...
  describe('order-specific pagination logic', () => {
    it('should handle first page of orders', () => {
      const firstPageOrders = {
        total: 100,
        page: 1,
        limit: 10,
        totalPages: 10,
      ...
      const dto = new PaginationMetaDto(firstPageOrders);
    ...
    it('should handle last page of orders', () => {
      ...
      const dto = new PaginationMetaDto(lastPageOrders);
    ...
    it('should handle single page of orders', () => {
      const singlePageOrders = {
        total: 5,
        page: 1,
        limit: 10,
        totalPages: 1,
      ...
      const dto = new PaginationMetaDto(singlePageOrders);
    ...
    it('should handle empty orders list', () => {
      ...
      const dto = new PaginationMetaDto(emptyOrders);
    ...
    it('should handle orders with custom page size', () => {
      const customPageSizeOrders = {
        total: 50,
        page: 3,
        limit: 15,
        totalPages: 4,
      ...
      const dto = new PaginationMetaDto(customPageSizeOrders);
  ...
  describe('edge cases', () => {
    ...
    it('should handle extreme order pagination scenarios', () => {
    ...
    it('should handle orders with different page sizes', () => {
      ...
      pageSizes.forEach(limit => {
        const dto = new PaginationMetaDto({
          ...
          hasNextPage: limit < 100,
          hasPreviousPage: false,
        });

        expect(dto.limit).toBe(limit);
        expect(dto.totalPages).toBe(Math.ceil(100 / limit));
      });
    });
  });
